                        ...
                        {stepper.state.all.map((step, index) => {
                            ...
                            return (
                                ...
                                >
                                    {index !== 0 && (
                                        <div
                                            className={`absolute top-4 left-[-50%] h-0.5 w-full -translate-y-1/2 ${isCompleted || isActive ? 'bg-primary' : 'bg-muted'}`}
                                        />
                                    )}
                                    <div
                                        className={`relative z-10 flex h-10 w-10 items-center justify-center rounded-full border-2 ${isActive ? 'border-primary bg-primary text-primary-foreground' : isCompleted ? 'border-primary bg-primary text-primary-foreground' : 'border-muted bg-background text-muted-foreground'}`}
                                    >
                                        {isCompleted ? (
                                    ...
                                    <span
                                        className={`mt-2 text-[10px] font-bold uppercase ${isActive ? 'text-primary' : 'text-muted-foreground'}`}
                                    >
                                        {step.title}
                                    </span>
                                </li>
